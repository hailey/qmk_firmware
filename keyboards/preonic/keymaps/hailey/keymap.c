...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, ALGR_T(KC_LALT), KC_LGUI, BACKLIT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______,  KC_F19, KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24 , S(KC_NUHS),S(KC_NUBS), KC_MNXT, KC_MPLY , _______,
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, QK_BOOT,   DEBUG,   _______, _______, _______, _______, TERM_ON, TERM_OFF,_______, KC_PAUS, KC_DEL,
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  KC_SCRL, KC_PSCR,
